...
<body>
	...
	<section class="main-section alabaster" style="min-height: 570px;background: white;">
		...
		<h2>Perhitungan Haversine</h2>
		<div align="justify"><b>1. Penentuan titik koordinat awal (sesuai dengan koordinat yang diinput user)</b><br>
			<table border="1">
				<tr>
					<td>
						Latitude
				...
				<tr>
					...
					<td>
						<?php echo $_SESSION['long'];?>
					</td>
				</tr>
			</table><br>
		</div>
		<div align="justify"><b>2. Konversi titik koordinat awal menjadi radian</b><br>
			<table border="1">
				<tr>
					<td>
						Latitude
				...
				<tr>
					<td>
						<?php echo 0.01745329252*$_SESSION['lat'];?>
					</td>
					<td>
						<?php echo 0.01745329252*$_SESSION['long'];?>
					</td>
				</tr>
			</table><br>
		</div>
		   <div class="table-responsive" style="width: 1179px;">
<b>3. Perhitungan dari titik awal ke setiap sekolah negeri</b><br>
	<div style="height: 370px;overflow-y: scroll;">
		<div align="justify">
			<table border="1">
				<tr>
					...
					<?php for($i=0;$i<count($bankx);$i++){ ?>
				<tr>
					<td>
						<?php echo $bankx[$i]["nama"];?>
					</td>
					<td>
						Acos (Sin (<?php echo 0.01745329252*$_SESSION['lat'];?>) *Sin (<?php echo 0.01745329252*$bankx[$i]["lat"];?>) +Cos (<?php echo 0.01745329252*$_SESSION['lat'];?>) *Cos (<?php echo 0.01745329252*$bankx[$i]["lat"];?>) *Cos (<?php echo 0.01745329252*$bankx[$i]["long"];?> - (<?php echo 0.01745329252*$_SESSION['long'];?>))))*6371
						
					</td>
					<td>
						<?php echo number_format($bankx[$i]["hasil"], 2); ?>
					</td>
				</tr>
				<?php }?>
			</table><br>
		</div></div></div><br>
		<div align="justify"><b>4. Perhitungan dari titik awal ke SD</b><br>
			<table border="1">
				<tr>
					<td>
						Nama
		...
		<div align="justify"><b>5. Perhitungan dari titik awal ke SMP</b><br>
			<table border="1">
				<tr>
					<td>
						Nama
		...
		<div align="justify"><b>6. Perhitungan dari titik awal ke SMA</b><br>
			<table border="1">
				<tr>
					<td>
						Nama
